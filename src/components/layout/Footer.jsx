...
export default function Footer() {
  return (
    <div className="flex flex-col bg-gray-200 px-5 md:px-10">
      
      <div className="bg-black relative -top-20 w-[99.5%] rounded-2xl p-5 sm:p-10 flex mx-auto">
        <div className="flex flex-wrap justify-center items-center w-full gap-5 md:flex-nowrap md:justify-between">
          ...
          <div className="flex flex-col gap-3 w-full md:w-1/3">
            ...
            <Button bgColor="bg-white" textColor="text-black" className="!w-full">
